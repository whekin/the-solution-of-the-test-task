...
const appAnimationDuration = 500;
const animationDuration = fadeAnimationDuration + appAnimationDuration * 2;
const colorThemes = [
  {
    mainColor: "#03a9f4",
...
/*
  nextColorTheme = () => {
    this.setState(state => ({
      currentColorTheme: state.currentColorTheme + 1 === colorThemes.length
        ? 0
        : state.currentColorTheme + 1,
    }), () => {
